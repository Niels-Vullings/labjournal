...
for (i in 1:1000) {
  ...
  simNets_M0[[i]] = getNet(100, ans_M0$sims[[i]][["Data1"]][["net"]][["1"]])
...
plot(GOF_M0, main = "Degree Distribution Model 0")

```

```{r}

GOF_dyads <- ts_dyads_evo(simNets_M0, soc_data$nets[1,,]) %>% filter(x != "Null...Null") %>% group_by(simnet) %>% mutate(stand = y/sum(y))

OBS_dyads <- ts_dyads_evo(soc_data$nets[2,,], soc_data$nets[1,,]) %>% filter(x != "Null...Null") %>% mutate(stand = y/sum(y)) %>% select(x,y,stand)


GOF_plot <- GOF_dyads %>% left_join(OBS_dyads, by = "x")
```

```{r, fig.width=9}

p_M0 <- ggplot(GOF_plot, aes(x=x, y=y.x) ) + 
...
for (i in 1:1000) {
  ...
  simNets_M1[[i]] = getNet(100, ans_M1$sims[[i]][["Data1"]][["net"]][["1"]])
...
plot(GOF_M1, main = "Degree Distribution Model 1")

```

```{r}

GOF_dyads <- ts_dyads_evo(simNets_M1, soc_data$nets[1,,]) %>% filter(x != "Null...Null") %>% group_by(simnet) %>% mutate(stand = y/sum(y))
...
for (i in 1:1000) {
  ...
  simNets_M2[[i]] = getNet(100, ans_M2$sims[[i]][["Data1"]][["net"]][["1"]])
...
plot(GOF_M2, main = "Degree Distribution Model 2")

```

```{r}

GOF_dyads <- ts_dyads_evo(simNets_M2, soc_data$nets[1,,]) %>% filter(x != "Null...Null") %>% group_by(simnet) %>% mutate(stand = y/sum(y))
...
p_M2 <- ggplot(GOF_plot, aes(x=x, y=y.x) ) + 
  geom_violin(fill = "grey", position=position_dodge(.8)) +
  stat_summary(fun = mean,
               geom = "errorbar",
               fun.max = function(x) mean(x) + sd(x),
...
for (i in 1:1000) {
  ...
  simNets_M2.5[[i]] = getNet(100, ans_M2.5$sims[[i]][["Data1"]][["net"]][["1"]])
...
plot(GOF_M2.5, main = "Degree Distribution Model 2.5")

```

```{r}

GOF_dyads <- ts_dyads_evo(simNets_M2.5, soc_data$nets[1,,]) %>% filter(x != "Null...Null") %>% group_by(simnet) %>% mutate(stand = y/sum(y))
...
p_M2.5 <- ggplot(GOF_plot, aes(x=x, y=y.x) ) + 
  geom_violin(fill = "grey", position=position_dodge(.8)) +
  stat_summary(fun = mean,
               geom = "errorbar",
               fun.max = function(x) mean(x) + sd(x),
...
for (i in 1:1000) {
  ...
  simNets_M3[[i]] = getNet(100, ans_M3$sims[[i]][["Data1"]][["net"]][["1"]])
...
plot(GOF_M3, main = "Degree Distribution Model 3")

```

```{r}

GOF_dyads <- ts_dyads_evo(simNets_M3, soc_data$nets[1,,]) %>% filter(x != "Null...Null") %>% group_by(simnet) %>% mutate(stand = y/sum(y))
...
p_M3 <- ggplot(GOF_plot, aes(x=x, y=y.x) ) + 
  geom_violin(fill = "grey", position=position_dodge(.8)) +
  stat_summary(fun = mean,
               geom = "errorbar",
               fun.max = function(x) mean(x) + sd(x),
...
for (i in 1:1000) {
  ...
  simNets_M4[[i]] = getNet(100, ans_M4$sims[[i]][["Data1"]][["net"]][["1"]])
...
plot(GOF_M4, main = "Degree Distribution Model 4")

```

```{r}

GOF_dyads <- ts_dyads_evo(simNets_M4, soc_data$nets[1,,]) %>% filter(x != "Null...Null") %>% group_by(simnet) %>% mutate(stand = y/sum(y))
...
p_M4 <- ggplot(GOF_plot, aes(x=x, y=y.x) ) + 
  geom_violin(fill = "grey", position=position_dodge(.8)) +
  stat_summary(fun = mean,
               geom = "errorbar",
               fun.max = function(x) mean(x) + sd(x),
...
for (i in 1:1000) {
  ...
  simNets_M5[[i]] = getNet(100, ans_M5$sims[[i]][["Data1"]][["net"]][["1"]])
...
plot(GOF_M5, main = "Degree Distribution Model 4")

```

```{r}

GOF_dyads <- ts_dyads_evo(simNets_M5, soc_data$nets[1,,]) %>% filter(x != "Null...Null") %>% group_by(simnet) %>% mutate(stand = y/sum(y))
...
p_M5 <- ggplot(GOF_plot, aes(x=x, y=y.x) ) + 
  geom_violin(fill = "grey", position=position_dodge(.8)) +
  stat_summary(fun = mean,
               geom = "errorbar",
               fun.max = function(x) mean(x) + sd(x),
