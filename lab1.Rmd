...
-   RQ 1: To what extent has gender segregation of publication networks in the Dutch social sciences changed between `r colorize("timepoint 1", "red")` and `r colorize("timepoint 2", "red")`?
