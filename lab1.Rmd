...
In a study that looked at the impact that networks have on gender differences in coauthorship, it was found that representation of women matters in relation to their network access [@mcdowell2006a]. The study looked at how male and female economist PhD's have access in their networks for publications and coauthorship. They find that over time, women are less likely to coauthor and publish articles compared to men. However, they also find that this probability does dwindle by 1993. When other forms of gender differences are included, women are less likely to be "succesful" in academics.

-   RQ 1: To what extent has gender segregation of publication networks in the Dutch social sciences changed between `r, colorize("red", "timepoint 1")` and `r, colorize("red", "timepoint 2")`?
