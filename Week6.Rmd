...
# Week 6
This week I mostly spend on updating my models and fixing my data. 
...
print01Report(mydata, modelname = "./results/soc_init_GOF")
...
## Step 4
```{r}
myAlgorithm <- sienaAlgorithmCreate(projname = "./results/soc_init_GOF")
...
```
```{r}
GOF <- sienaGOF(ansM1, IndegreeDistribution, verbose = FALSE, join = TRUE, varName = "net")
